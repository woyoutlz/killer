  ...
  if (value) {
    if (!isPlainObject(value)) {
      ...
      for (var key in value) {
        ...
        var ours = value[key];
        on$$1[key] = existing ? [].concat(ours, existing) : ours;
      }
    }
  }
  return data
...
var App = {render: function(){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{attrs:{"id":"app"}},[_c('p',_vm._l((_vm.peoples),function(people){return _c('span',{staticClass:"people_span"},[_c('a',{on:{"click":function($event){_vm.add(people);}}},[_vm._v(_vm._s(people))])])})),_c('p',_vm._l((_vm.jiaoses),function(jiaose){return _c('span',{staticClass:"people_span"},[_c('a',{on:{"click":function($event){_vm.add(jiaose);}}},[_vm._v(_vm._s(jiaose))])])})),_c('p',_vm._l((_vm.actions),function(action){return _c('span',{staticClass:"people_span"},[_c('a',{on:{"click":function($event){_vm.add(action);}}},[_vm._v(_vm._s(action))])])})),_c('p',{staticClass:"record_p"},_vm._l((_vm.out_control),function(con){return _c('span',{staticClass:"people_span"},[_c('a',{on:{"click":function($event){_vm.control(con);}}},[_vm._v(_vm._s(con))])])})),_c('p',{staticClass:"record_p"},_vm._l((_vm.records),function(record){return _c('span',{staticClass:"people_span"},[_c('a',[_vm._v(_vm._s(record))])])}))])},staticRenderFns: [],_scopeId: 'data-v-472cff63',
  name: 'app',
  components:{
  },
  data () {
    return {
        peoples:[...Array(10).keys()].map(function(a){return a+1}),
        jiaoses:["狼","预言","女巫","民","猎人","丘比特","神"],
        actions:["觉得","查","自称","同意","质疑","投票","..."],
        records:[],
        out_control:["删除","选择","换行"]
    }
  },
  methods:{
    add:function(some){
      this.records.push(some);
    },
